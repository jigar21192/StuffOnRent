        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(img1.getTag()!="tt"){
                    ...
                    Toast.makeText(UploadFurniture.this, "Image Is Required", Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(UploadFurniture.this, "Item Name Is Required", Toast.LENGTH_SHORT).show();
                }

                else if(TextUtils.isEmpty(itemprice)){

                    Toast.makeText(UploadFurniture.this, "Item Rent Is Required", Toast.LENGTH_SHORT).show();
                }

                else if(TextUtils.isEmpty(location)){

                    Toast.makeText(UploadFurniture.this, "Your Location Is Required", Toast.LENGTH_SHORT).show();
                }

                else if(TextUtils.isEmpty(description)){

                    Toast.makeText(UploadFurniture.this, "Please Enter Some Description For Item", Toast.LENGTH_SHORT).show();
                }

                else {

                    Toast.makeText(UploadFurniture.this, "Item Upload Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
